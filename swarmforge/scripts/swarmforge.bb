...
(defn tool-startup-section [role last-role?]
  (let [tools (get role-required-tools role [])]
    (str "## Tool Startup\n\n"
         ...
         "- Constitution tools: `swarm_tool.sh require crap4clj` (also dry4clj, clj-mutate, cloverage, speclj, speclj-structure-check, crap4py, mutate4py, symilar, pytest, coverage, APS, or the language table). If missing, `swarm_tool.sh ensure <tool>`. Do not invent project `bb` proxies.\n"
